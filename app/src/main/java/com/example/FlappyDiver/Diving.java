...
public class Diving {
    ...
    Diving(int screenY, Resources res){
        ...
        diving1= BitmapFactory.decodeResource(res,R.drawable.diving1,options);
        diving2= BitmapFactory.decodeResource(res,R.drawable.dving2,options);
        diving3= BitmapFactory.decodeResource(res,R.drawable.diving4,options);
