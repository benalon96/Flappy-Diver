...
public class Shark {
    ...
    Shark(Resources resources){
        ...
        shark1= BitmapFactory.decodeResource(resources,R.drawable.shark1,options);
        shark2= BitmapFactory.decodeResource(resources,R.drawable.shark2,options);
        shark3= BitmapFactory.decodeResource(resources,R.drawable.shark1,options);
        shark4= BitmapFactory.decodeResource(resources,R.drawable.shark2,options);
