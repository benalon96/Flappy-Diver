...
public class Coin {
    ...
    Coin(Resources resources){
       ...
       coin1= BitmapFactory.decodeResource(resources,R.drawable.coins,options);
        coin2= BitmapFactory.decodeResource(resources,R.drawable.coins,options);
        coin3= BitmapFactory.decodeResource(resources,R.drawable.coins,options);
        coin4= BitmapFactory.decodeResource(resources,R.drawable.coins,options);
